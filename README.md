...
In **exp07**, with **θ fixed**, a φ×l\* grid is swept and Δ is numerically optimized at each point to produce paper Fig.6-style maps (numerical only).
...
| exp07 | `experiments/exp07_sweep_phi_l.py` | Done | With-wall Blakelet φ×l sweep (θ fixed, Δ optimized per point, Fig.6 style) |
...
└── cilia_simulation/
    ...
    ├── PHYSICS_REPORT.md     # Physics and math explanation (exp01–exp07)
